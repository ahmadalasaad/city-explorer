...
class CityList extends Component {
  ...
  renderlist=()=>{
        ...
        <div>
            ...
            <img src={`https://maps.locationiq.com/v3/staticmap?key=${process.env.REACT_APP_LOCATION_IQ_KEY}&center=${this.props.locationData.lat},${this.props.locationData.lon}&zoom=5&size=600x600&format=png&maptype=roadmap&markers=icon:<icon>|${this.props.locationData.lat},${this.props.locationData.lon}&markers=icon:small-red-blank|${this.props.locationData.lat},${this.props.locationData.lon}`} alt=''/>
        </div>)
